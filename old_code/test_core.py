"""
Unit tests for geneset-annotator core functionality.
"""
...
from geneset_annotator.llm.base import BaseLLMProvider
from geneset_annotator.enrichment import CustomEnrichment
...
@patch('geneset_annotator.enrichment.gp.enrichr')
def test_pathway_enrichment_integration(mock_enrichr, sample_deg_df, mock_llm_provider):
...
@patch('geneset_annotator.core.OpenAIProvider')
