"""
Core annotation API for geneset-annotator.
"""

import pandas as pd
from typing import List, Optional, Union
from .llm.base import BaseLLMProvider
from .enrichment import BaseEnrichment, create_enrichment
...
class GeneSetAnnotator:
    ...
    def __init__(
        ...
        **enrichment_kwargs
        ...
        >>> from geneset_annotator.llm import OpenAIProvider
        >>> 
        ...
        if pathways is not None:
            ...
            try:
                ...
                if enr_results is not None and len(enr_results) > 0:
                    ...
                    pathway_terms = enr_results["Term"].astype(str).tolist()[:max_pathway_num]
...
def annotate_gene_set_with_llm(
    ...
    """
    from .llm.base import OpenAIProvider
